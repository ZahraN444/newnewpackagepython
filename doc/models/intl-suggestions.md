...
|  --- | --- | --- | --- |
| `primary_number_range` | `str` | Required | The primary number range of the address that identifies a building at street level. |
...
| `zip_code` | `str` | Required | The postal code.<br>**Constraints**: *Maximum Length*: `12` |
